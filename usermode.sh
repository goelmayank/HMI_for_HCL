...
while [[ $index -ge 0 && $index -le 5 ]]; do
    ...
    c=$index
    if [[ $c -eq 3 && ${t[3]} -gt ${monthLimit[month_index]} ]]; then
        t[3]=${lowerLimit[3]}
        ((t[4]++))
        c=4
    fi
...
i2cset -y 1 0x68 00 ${t[0]}
i2cset -y 1 0x68 01 ${t[1]}
i2cset -y 1 0x68 02 ${t[2]}
i2cset -y 1 0x68 04 ${t[3]}
i2cset -y 1 0x68 05 ${t[4]}
i2cset -y 1 0x68 06 ${t[5]}
